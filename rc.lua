...
-- start gnomesettingsdaemon and nmapplet2
...
tags = {
  names = {"1|main", "2|code", "3|www", "4|irc", "5|multimedia", "6|others"},
  layout = {layouts[1], layouts[2], layouts[2],layouts[2],layouts[2],layouts[2],layouts[2],layouts[2]}}
