...
-- separator widget
local separator_widget = require("awesome-wm-widgets.separator-widget.separator")

awful_spawn.with_shell("xsettingsd")
awful_spawn.with_shell("nm-tray")
-- awful_spawn.with_shell("wicd-gtk --tray")
awful_spawn.with_shell("synclient MaxTapTime=50")
awful_spawn.with_shell("synclient VertEdgeScroll=50")
...
globalkeys = awful.util.table.join(
   ...
   awful.key({ }, "#233", function () awful.util.spawn("xbacklight -inc 5") end),
